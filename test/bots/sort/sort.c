...
{/*{{{*/
    ...
    *(lowdest + lowsize + 1) = *split1;
    ...
    struct mir_task_t* task_0 = mir_task_create((mir_tfunc_t) _smp__ol_cilkmerge_par_0, (void*) &imm_args_0, sizeof(_nx_data_env_0_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_1 = mir_task_create((mir_tfunc_t) _smp__ol_cilkmerge_par_1, (void*) &imm_args_1, sizeof(_nx_data_env_1_t), 0, NULL, NULL);
...
{/*{{{*/
    ...
    struct mir_task_t* task_2 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_2, (void*) &imm_args_2, sizeof(_nx_data_env_2_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_3 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_3, (void*) &imm_args_3, sizeof(_nx_data_env_3_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_4 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_4, (void*) &imm_args_4, sizeof(_nx_data_env_4_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_5 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_5, (void*) &imm_args_5, sizeof(_nx_data_env_5_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_6 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_6, (void*) &imm_args_6, sizeof(_nx_data_env_6_t), 0, NULL, NULL);
    ...
    struct mir_task_t* task_7 = mir_task_create((mir_tfunc_t) _smp__ol_cilksort_par_7, (void*) &imm_args_7, sizeof(_nx_data_env_7_t), 0, NULL, NULL);
...
{/*{{{*/
    ...
    struct mir_task_t* task_8 = mir_task_create((mir_tfunc_t) _smp__ol_sort_par_8, (void*) &imm_args_8, sizeof(_nx_data_env_8_t), 0, NULL, NULL);
