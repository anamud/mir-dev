...
\begin{itemize}
\item You should have recieved the GPL implementation of the libGOMP interface in a package seperate from MIR sources. Point the environment variable MIR\_OMP\_INT\_ROOT to the location of the package.
...
$ ln -s $MIR_OMP_INT_ROOT/mir_omp_int.h mir_omp_int.h
\end{lstlisting}
...
\begin{itemize}
    \item Use \texttt{taskwait} explicitly to sychronize tasks. Do not expect implicit taskwaits within thread barriers.
